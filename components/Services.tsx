          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Link key={index} href={service.url} passHref>
                <div className="service-card bg-white rounded-xl p-8 transition-all duration-300 hover:shadow-lg group flex flex-col h-full min-h-[400px] opacity-0 transform translate-y-10 animate-on-scroll">
                  <div
                  ...
                  <p className="text-[#1f72b7] font-semibold hover:text-[#1f72b7] transition-colors duration-300">
                    Learn more
                  </p>
                </div>
              </Link>
