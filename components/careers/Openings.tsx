        ...
        <AnimateOnScroll>
          <div className="mb-12">
            <h2 className="text-4xl font-bold mb-6">
              <span className="text-[#1f72b7]">We're Hiring!</span> Your skills
              are valued
            </h2>
            <p className="text-lg text-gray-300 max-w-3xl">
              Tesla is looking for talented and skilled professionals from the
              tech and design domain to be a part of a revolutionary company
        ...
        <div className="space-y-6">
          {openings.map((job, index) => (
            <AnimateOnScroll key={index}>
              <div
                className="job-card bg-[#1A1A1A] rounded-lg overflow-hidden transition-all duration-300"
                data-open="false"
              >
                <div className="p-6">
